...
var modelSucess = {
    texto: [
        {
            conteudo: "Vocês acabam de receber o título de combatentes do Aedes, \
...
var modelApresentacao = {
    texto: [
        ...
        },
        {
            ...
            Segundo a Organização Mundial de Saúde (checar informação) mais de 750 mil pessoas\
             morrem anualmente no mundo por causa da picada de mosquitos."
        },
        {
            conteudo: "São quatro espécies principais: Aedes albopictus, Culex, Anopheles Gambiae e Aedes Aegypti. \
            Focaremos nossa atenção no Aedes aegypti." 
        },
        {
            conteudo: "No Brasil, foram quase 800 mortes em 2016, destas 629 foram dengue. \
            E na sua cidade, bairro ou rua, Você já ouviu falar em algum caso de pessoas que se infectaram por Dengue, \
            Zyka, Chikungunya e Febre amarela?" 
        },
        {
